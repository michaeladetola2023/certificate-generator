...
function addText(
  ...
  ctx.fillText(text, xPos, yPos);
    ...
    //DOWNLOADING OF CERTIFICATE IMAGE
    //
...
function sendImage() {
  ...
  let downloadType = downloadTypeButton.value;
  let sendBtn = document.querySelector('#downloadbutton');
  sendBtn.addEventListener('click',function(e) {
    ...
    console.log(certowner);
      ...
      xml.open("POST", "http://localhost/checkimage/server.php", true);
      xml.setRequestHeader("Content-type","application/x-www-form-urlencoded");
      xml.send("certificate="+JSON.stringify(certowner));
